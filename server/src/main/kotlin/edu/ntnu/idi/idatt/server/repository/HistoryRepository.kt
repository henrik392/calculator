...
interface HistoryRepository {
     ...
     *
     * @param username The ID of the user whose history items to retrieve
     ...
     */
    fun getHistory(username: String, page: Int, size: Int): Pair<List<HistoryItem>, Int>

    /**
     * Adds a new history item for a specific user.
     *
     * @param username The ID of the user to add the history item for
     * @param expression The expression that was calculated
     * @param result The result of the calculation
     */
    fun addHistory(username: String, expression: String, result: Double)
}